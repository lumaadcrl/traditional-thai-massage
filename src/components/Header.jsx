  ...
  return (
    <header className={`fixed top-0 left-0 w-full z-50 transition-colors duration-300 ${isScrolled ? 'bg-[#205C4A] shadow-md' : 'bg-transparent'}`}>
          ...
          <div className="flex justify-between items-center gap-4">
            ...
            <div className="flex justify-between items-center gap-4">
              <div className="flex font-semibold text-white text-[18px]">
                  <a target='_blank' href="#" className="bx bxl-instagram px-3"></a>
                  <a target='_blank' href="#" className="bx bxl-facebook px-3"></a>
              </div>
      ...
      <div
        ...
        } absolute w-full flex-col items-center bg-[#205C4A] shadow-lg text-white uppercase font-semibold z-50`}
      >
